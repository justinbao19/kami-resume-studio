...
- Photo-capable families in the web editor: `editorial`, `technical`, `creative`, `early-career`, `aqua-ledger`, `atelier-serif`, `cupertino`, and `swiss-grid`.
...
| Retail, hospitality, customer service, skilled trades, logistics frontline | operations-practical | ats-classic, early-career |
