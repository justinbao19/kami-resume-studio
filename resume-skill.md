...
6. Choose the output language, one of 14 resume families, a light or dark theme, and template, white, or ivory paper for light output.
...
The editor and Agent router expose 14 families and 28 light/dark variants. Light output supports template-default, white, and ivory paper. Every family supports project experience.
...
| `aqua-ledger` | 冰川履历 / Aqua Ledger | Polished operations, program work, service | yes | text |
| `slate-sidebar` | 侧写 / Slate Sidebar | International operations, community, market expansion | yes | text |
