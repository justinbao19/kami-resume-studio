...
HOMEPAGE = "https://github.com/justinbao19/kami-resume-studio"
REPOSITORY = "https://github.com/justinbao19/kami-resume-studio"
SITE = "https://kami-resume-studio.vercel.app"

AUTHOR = {
    "name": "JustinBao",
    "email": "97433668+justinbao19@users.noreply.github.com",
    "url": "https://github.com/justinbao19",
}
...
CODEX_DESCRIPTION = (
    ...
    "match target jobs, route 9 resume families with light/dark themes, and render "
...
CLAUDE_PLUGIN_DESCRIPTION = (
    "Build evidence-backed, job-targeted resumes from authorized career sources, "
    "then typeset them with the Kami design system."
)
...
def build_codex_plugin(version: str, brand_color: str) -> dict:
    return {
        ...
        "interface": {
            "displayName": "Kami",
            "shortDescription": "Generate evidence-backed, job-targeted resumes",
            "longDescription": (
                "Kami helps an agent turn authorized old resumes, LinkedIn or "
                ...
                "9 resume families with light/dark themes, renders an expressive "
            ...
            "websiteURL": HOMEPAGE,
            "defaultPrompt": [
                "Build a job-targeted resume from my old PDF and LinkedIn profile",
                "Interview me about my latest role and generate an ATS resume",
...
SKILL_WHEN_TO_USE = (
    "Use when a user asks for a job-targeted resume, CV, career profile, or "
    "resume rewrite from an old PDF, LinkedIn, BOSS 直聘, 猎聘, 58 同城, portfolio, "
    "or target job description. Kami extracts authorized sources, asks evidence "
    "questions for missing recent work, chooses a suitable resume family/theme, "
    "and renders an ATS-safe companion when needed. Also use it when a user asks "
    "for a finished document whose appearance matters: a one-pager, letter, "
    "portfolio, long report, slide deck, equity report, changelog, or landing "
    "page. Skip it when the user only wants plain text."
)
...
def build_mcp_server_card(version: str, protocol: str, tools: list[dict]) -> dict:
    return {
        ...
        "packages": [
            {
                "registryType": "github",
                "identifier": "justinbao19/kami-resume-studio",
                "version": version,
