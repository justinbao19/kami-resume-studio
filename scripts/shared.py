...
PUBLIC_REPO = "justinbao19/kami-resume-studio"
...
CLAUDE_DESKTOP_PACKAGE_URL = "https://github.com/justinbao19/kami-resume-studio/releases/latest/download/kami.zip"
